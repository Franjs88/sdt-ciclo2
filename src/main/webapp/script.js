        ...
        botonDescargar.on('click', function(){
            ...
            $.get ('/sdt-ciclo2/ControladorServlet',function (data, status){
                var n = data;
                post(0,n);
                }).fail(function (data,status){console.log('Falla GET');});
        });
        ...
        function post(i,n){
          ...
          $.post('ControladorServlet?i='+ i ,i ,function(data,status) {
             // console.log(data);
